...
const Footer = () => {
  return (
    ...
    <a  style={{"textDecoration":"none"}} rel="noreferrer" target="_blank" href="https://www.privacypolicygenerator.info/live.php?token=bllJv5apfdXnh9cMVC4pLanSVm6KWY9z"><span className="c" style={{background:"transparent",color:"white",border:"none",textAlign:"center"}}>Privacy Policy&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
    <a  style={{"textDecoration":"none"}} rel="noreferrer"  target="_blank" href="https://www.termsofusegenerator.net/live.php?token=4EEmmwJkQlkwZcVqFTpGEjttqtWRCOI8"><span className="c" style={{background:"transparent",color:"white",border:"none",textAlign:"center"}}>Terms of use</span></a>
